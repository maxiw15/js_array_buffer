## `Math (log/trig)` (Домашнее задание к лекции «`ArrayBuffer`») 
[![Build status](https://ci.appveyor.com/api/projects/status/nxt8rmkm8xb3hmkj?svg=true)](https://ci.appveyor.com/project/bas27/fpyajs-array-buffer-1)
